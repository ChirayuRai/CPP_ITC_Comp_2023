  ...
  return (
    ...
    >
      <div className="bg-blue-400 p-8 bg-opacity-30 rounded-lg shadow-md w-full max-w-2xl mx-auto border-4 border-black">
        ...
        >
          In Icelandic, "hæli" is a noun that translates to "shelter" or "protection" in English. It refers to a place or situation that provides safety from adverse weather, danger, or any other threatening conditions
        </p>
        <br />
        <p
          className="text-left text-white font-bold text-2xl"
        ...
        ><a href="https://www.linkedin.com/in/amoghprak/" target="_blank" className="hover:text-slate-300"> Amogh Prakash </a>, <a href="https://www.linkedin.com/in/chirayu-rai/" target="_blank" className="hover:text-slate-300"> Chirayu Rai </a>, <a href="https://www.linkedin.com/in/gerardosolisit/" target="_blank" className="hover:text-slate-300"> Gerardo Solis </a>, <a href="https://www.linkedin.com/in/andy-diep/" target="_blank" className="hover:text-slate-300"> Andy Diep </a>, <a href="https://www.linkedin.com/in/sararosec/" target="_blank" className="hover:text-slate-300"> Sara Cozart </a></p>
        <br />
        <p
          className="text-left text-white font-bold text-2xl"
          style={{
