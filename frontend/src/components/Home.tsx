        ...
        >
          <div className="p-4 mt-2">
            ...
            >
              ...
              <div
                className={`absolute z-10 border-4 border-black w-full bg-blue-500 bg-opacity-20 p-6 rounded-lg shadow-lg transition-all duration-300  ${collapsedEdit ? "hidden" : "block"
                  }`}
              >
                <ProfileView
